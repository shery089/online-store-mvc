...
//        }
    ...
    public function create($index, $map = false)
    {
        $this->index = $index;
    ...
    public function insert_bulk($type,$method = 'POST',$data)
    {
        return $this -> call($type . '/_bulk', $method, $data);
    }
    ...
    {
        return $this -> call($index, 'DELETE', 'delete_index');
    }

    public function refresh_index_type($index, $type='', $id='')
    {
        $this->index = $index;
...
//        if(empty($id) && empty($type)) {
            ...
            $method = 'POST';
/*        else {
            $call = $type . '/' . $id . '/?refresh';
            $method = 'PUT';
        }*/

        return $this -> call($call, $method);
    }

    public function update_partial_index($index, $type, $id, $data)
    {
        $this->index = $index;
    ...
    public function advancedquery($index, $type, $query)
    {
        $this->index = $index;
