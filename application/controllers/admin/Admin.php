...
class Admin extends CI_Controller {
	...
	public function recover_password()
	{
	    ...
	    else
	    {
	    	if($this->admin_model->email_exists($email))
	    	{
				...
				$msgcontents = '<p>Hi, We got a request to reset your password</p><a href=' . site_url('admin/admin/new_password') . '/' . $token . '>Reset Password<a><p>If you ignore this message, your password won\'t change</p>';
				...
				if ($mailsend) 
				{
					redirect('admin/admin/mail_send_message');
				}	    	
	    	}
	    	else
	    	{
	...
	public function new_password()
	{
		...
		{
			redirect('admin/admin/recover_password');
		}
