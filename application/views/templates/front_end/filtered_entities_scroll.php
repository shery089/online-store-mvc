<?php ob_start(); ?>
  ...
  <div class="col-lg-12 light-border" id="filtered_results">
    <?php
      if(!empty($this->input->post('cookie_gender_age')))
      {
        unset($_POST['cookie_gender_age']);
        $cookie = array(
      ...
      if(!empty($this->input->post('cookie_gender')))
      {
        unset($_POST['cookie_gender']);
        $cookie = array(
      ...
      {
        if(!empty($this->input->post('cookie_age')))
        {
        unset($_POST['cookie_age']);
          $cookie = array(
  ...
  ?>
  <?php if(get_cookie('age') == 0 && get_cookie('gender') == 0): ?>
    <h3 class="text-center">No More Records</h3>
  <?php elseif(get_cookie('gender') == 0): ?>
    <h3 class="text-center">No More Records</h3>
  <?php elseif(get_cookie('age') == 0): ?>
    <h3 class="text-center">No More Records</h3>
  <?php else: ?>
