<?php ob_start(); ?>         
    <div class="col-lg-11 col-md-11 post-comm-sec text-justify comment-right"><strong class="comm-name">  <?= $result['full_name'] ?> </strong>&nbsp;
        ...
        <ul class="comm-actions pull-left"> 
            ...
            <li class="comm-actions-li">
                <time class="timeago" datetime="<?= ($result['edit_date'] == '0000-00-00') ? $result['date'] . ' ' .  $result['time'] : $result['edit_date'] . ' ' . $result['edit_time']; ?>"></time>
            </li>
            <?php if ($result['edit_date'] != '0000-00-00'): ?>
              <li class="comm-actions-li">
                <span>Edited</span>
              </li>
            <?php endif ?>
