      ...
      <div class="col-lg-12 light-border pull-left">
        <div class="col-lg-6 col-md-6 comm-top">
          <ul class="post text-justify">
              ...
              <i class="fa fa-star-o" aria-hidden="true"></i>
              <i class="fa fa-star-o" aria-hidden="true"></i>
            <h5 id="post-user">Sheryar Ahmed</h5>
            <em>February, 05</em>
          </ul>
        </div>
        ...
        <div class="col-lg-6 col-md-6 comm-top post-top-actions-div pull-left">
          <!-- <div class="pull-left"> -->
            <ul class="post-top-actions">
              <li class="post-top-actions-li pull-left"><a id ="post-like" class="post-top-actions-li-item" href="javascript:void(0);">Like</a>: </li>
              <li class="post-top-actions-li pull-left"><a id ="post-dislike" class="post-top-actions-li-item" href="javascript:void(0);">Dislike</a>: </li>
              <li class="post-top-actions-li pull-left"><a id ="post-comment" class="post-top-actions-li-item" href="javascript:void(0);">Comments</a>: </li>
            </ul>
          <!-- </div> -->
        </div>
        ...
        <div class="col-lg-12 actual-post">
          <div class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ratione blanditiis placeat eos magni, ut consequuntur iste sapiente, consequatur quo tenetur at pariatur quaerat? Aliquid velit voluptatem corrupti odit explicabo.</div>
        </div>
        <div class="clearfix"></div>
