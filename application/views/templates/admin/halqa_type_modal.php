...
<div id="modal" class="modal fade" tabindex="-1" halqa_type="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm"> 
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="closeModel()" aria-hidden="true">×</button>
                <h4 class="text-center"><?= ($action = $this->input->post('action')) == 'delete' ? "Are You Sure?" : "Halqa Type Details"; ?></h4>
            </div>
                                ...
                                <table class="table table-bordered table-condensed table-striped admin-table text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= ucwords(entity_decode($halqa_type['abbreviation'])); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <?php
                    if($action == 'delete'): ?>
                        <a href="<?= site_url('admin/halqa_type/delete_halqa_type_by_id_lookup/' . $halqa_type['id']) ?>" class="btn btn-danger">Delete</a>
                    <?php endif; ?>
                </div>
