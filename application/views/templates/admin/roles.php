				...
				<table class="table table-bordered table-striped table">
				    ...
				    <?php foreach ($roles as $role): ?>
				    	<tr>
				   			...
				   			<td>
				   				<a href="<?= base_url('admin/role/edit_role_lookup/') . '/' . $role['id']; ?>" class="btn btn-sm btn-success actions"><span class="fa fa-pencil-alt"></span></a>
								<a href="javascript:void(0)" id="delete_<?= $role['id']; ?>" class="btn btn-sm btn-danger actions"><span class="fa fa-window-close"></span></a>
