 <div id="page-wrapper">
    <div class="row">
        ...
        <button id="delete_new_product_attribute_section" type="button" title="Remove Last Product Attribute" class="btn btn-danger btn-circle <?= count($selected_product_attributes) > 1 ? '' : 'hide' ?>"><i class="fa fa-window-close"></i></button>
        </div>
    </div>
