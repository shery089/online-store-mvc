						...
						<tr>
							...
							<td><?= ucwords($product['name']); ?></td>
				   			...
				   			<td>
								...
								<a title="Product Gallery" href="<?= base_url('admin/gallery/add_gallery_pics_lookup') . '/' . ucwords($product['id']); ?>" class="btn btn-sm btn-warning actions" style="display: inline-block;"><span class="fa fa-images"></span></a>
								<a title="Edit Product Description" href="<?= base_url('admin/product/edit_product_description_lookup') . '/' . ucwords($product['id']); ?>" class="btn btn-sm btn-primary actions" style="display: inline-block;"><span class="fa fa-copy"></span></a>
								...
								<a title="Product Description" href="javascript:void(0)" id="view_<?= ucwords($product['id']); ?>" class="btn btn-sm btn-info actions" style="display: inline-block;"><span class="fa fa-comment-dots"></span></a>
