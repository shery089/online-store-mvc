        ...
        <div class="modal-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-condensed table-striped admin-table">
                                    <thead>
                                        ...
                                        <th class="text-center">Phone Number(s)</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center"><?= ucwords($company['name']); ?></td>
                                            <td class="text-center"><?= $company['email']; ?></td>
                                            <td class="text-center"><?= ($company['phone_number']); ?></td>
                                            <td class="text-center"><?= ($company['website']); ?></td>
                                            <td class="text-center"><?= str_replace( array('\r\n','\n\r','\n','\r'), '<br>' , $company['description']); ?></td>
                                            <td class="text-center"><?= ucwords($company['joined_date']); ?></td>
                                            <td class="text-center"><?= ucwords($company['updated_date']); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <?php
                    if($action == 'delete'): ?>
                        <a href="<?= site_url('admin/company/delete_company_by_id_lookup/' . ucwords($company['id'])); ?>" class="btn btn-danger">Delete</a>
                    <?php endif; ?>
                </div>
